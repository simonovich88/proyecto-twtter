class ApiController < InheritedResources::Base
    ...
    http_basic_authenticate_with name: "user", password: "pass", :except => ["news", "tweet_filter"]
    ...
    def tweet_filter
      ...
      @tweets = Tweet.date_filter(start_time, end_time+1)
      @filter_api = []
      @retweet_list = Tweet.where.not(:tweet_id => nil)
